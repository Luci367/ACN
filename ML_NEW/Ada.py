...
class MachineLearning:
    ...
    def flow_training(self):
        ...
        classifier = AdaBoostClassifier(estimator=base_estimator, random_state=0)
        ...
        # classes = ['Class 0', 'Class 1', 'Class 2', 'Class 3']  # Need to Update classes according to dataset
        # x = ['TP', 'FP', 'FN', 'TN']
        # x_indexes = range(len(x))
        # plt.title("Adaboost with Decision Tree")
        # plt.xlabel('Predicted Class')
        # plt.ylabel('Number of Instances')
        # plt.bar(x_indexes, cm.flatten(), color="#e0d692", label='Adaboost')
