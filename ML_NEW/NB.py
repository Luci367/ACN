...
class MachineLearning:
    ...
    def flow_training(self):
        ...
        # Adjusting the plotting for different matrix dimensions
        # x = ['TP', 'FP', 'FN', 'TN'] if cm.shape == (2, 2) else [f'Class {i}' for i in range(len(cm))]
        # y = [cm[i, j] for i in range(len(cm)) for j in range(len(cm[0]))]
